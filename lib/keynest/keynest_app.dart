...
class _NemokeyHomeScreenState extends State<NemokeyHomeScreen>
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  subtitle: const Text('保存済みサービスとサブスクを確認'),
                  onTap: () async {
                    Navigator.of(context).pop();
                    await _openServiceListScreen();
                  },
                ),
                ListTile(
  ...
  Future<void> _openServiceListScreen() async {
  ...
  Widget _buildCodesTab() {
    return ListView(
      ...
      children: [
        ...
        Card(
          child: ListTile(
            onTap: _openServiceListScreen,
            leading: const Icon(Icons.inventory_2_outlined),
            title: const Text(
              'サービス一覧',
              style: TextStyle(fontWeight: FontWeight.w800),
            ),
            subtitle: const Text('保存済みサービス、ID、サブスク料金を確認'),
